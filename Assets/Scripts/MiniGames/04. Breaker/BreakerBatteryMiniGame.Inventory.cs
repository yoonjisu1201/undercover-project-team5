...
public sealed partial class BreakerBatteryMiniGame
{
    ...
    private void StageInventoryBatteries()
    {
        ...
        MoveCarriedBatteriesToMiniGame();
    }

    // 미니게임 UI는 닫아도 파괴되지 않고 재사용되므로, 다시 열 때 그 사이에 새로 주운 건전지도 보관함에 들어와야 한다.
    ...
    // 플레이어가 들고 있는 건전지를 미니게임 보관함으로 옮기고, 옮긴 것만 보관 목록에 기록한다.
    private void MoveCarriedBatteriesToMiniGame()
    {
